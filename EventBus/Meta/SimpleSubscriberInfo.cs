...
namespace Snork.EventBus.Meta
{
    ...
    public class SimpleSubscriberInfo : AbstractSubscriberInfo
    {
        ...
        public SimpleSubscriberInfo(Type subscriberClass, bool shouldCheckSuperclass,
            List<SubscriberMethodInfo> methodInfos) : base(subscriberClass, null, shouldCheckSuperclass)
        {
